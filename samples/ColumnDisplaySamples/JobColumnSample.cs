...
{
    internal override string SampleGroupDescription
...
public class JobColumnSample1_RunModes_JobColumnSelectionProvider : JobColumnSample1_RunModes
{
    ...
    internal new class SampleConfig : JobColumnSample1_RunModes.SampleConfig
    {
        public SampleConfig() : base()
            => this.ReplaceColumnCategory(new JobColumnSelectionProvider(
                "-all +Job", showHiddenValuesInLegend: true));
    }
}
...
public class JobColumnSample2_Runtimes_JobColumnSelectionProvider : JobColumnSample2_Runtimes
{
    ...
    // Same config as above, but now with JobColumnSelectionProvider
    internal new class SampleConfig : JobColumnSample2_Runtimes.SampleConfig
    {
        public SampleConfig() : base()
