...
|  Method |        Job |            Runtime |    Toolchain |     Mean | Error | Ratio |
|-------- |----------- |------------------- |------------- |---------:|------:|------:|
| Method1 | Job-AMPVQL |           .NET 5.0 |       net5.0 | 102.0 ms |    NA |  1.00 |
| Method2 | Job-AMPVQL |           .NET 5.0 |       net5.0 | 105.0 ms |    NA |  1.03 |
| Method3 | Job-AMPVQL |           .NET 5.0 |       net5.0 | 108.0 ms |    NA |  1.06 |
| Method1 | Job-THQSYC |      .NET Core 3.1 | netcoreapp31 | 101.0 ms |    NA |  0.99 |
| Method2 | Job-THQSYC |      .NET Core 3.1 | netcoreapp31 | 104.0 ms |    NA |  1.02 |
| Method3 | Job-THQSYC |      .NET Core 3.1 | netcoreapp31 | 107.0 ms |    NA |  1.05 |
| Method1 | Job-ZWOXKQ | .NET Framework 4.8 |        net48 | 100.0 ms |    NA |  0.98 |
| Method2 | Job-ZWOXKQ | .NET Framework 4.8 |        net48 | 103.0 ms |    NA |  1.01 |
| Method3 | Job-ZWOXKQ | .NET Framework 4.8 |        net48 | 106.0 ms |    NA |  1.04 |
...
|-------- |----------- |------------------- |------------- |------ |----- |---------:|------:|------:|
| Method3 | Job-AMPVQL |           .NET 5.0 |       net5.0 | False |   44 | 125.0 ms |    NA |  1.00 |
| Method3 | Job-THQSYC |      .NET Core 3.1 | netcoreapp31 | False |   44 | 123.0 ms |    NA |  0.98 |
| Method3 | Job-ZWOXKQ | .NET Framework 4.8 |        net48 | False |   44 | 121.0 ms |    NA |  0.97 |
|         |            |                    |              |       |      |          |       |       |
| Method1 | Job-AMPVQL |           .NET 5.0 |       net5.0 | False |    ? | 113.0 ms |    NA |  1.00 |
| Method1 | Job-THQSYC |      .NET Core 3.1 | netcoreapp31 | False |    ? | 111.0 ms |    NA |  0.98 |
| Method1 | Job-ZWOXKQ | .NET Framework 4.8 |        net48 | False |    ? | 109.0 ms |    NA |  0.96 |
|         |            |                    |              |       |      |          |       |       |
| Method2 | Job-AMPVQL |           .NET 5.0 |       net5.0 | False |    ? | 119.0 ms |    NA |  1.00 |
| Method2 | Job-THQSYC |      .NET Core 3.1 | netcoreapp31 | False |    ? | 117.0 ms |    NA |  0.98 |
| Method2 | Job-ZWOXKQ | .NET Framework 4.8 |        net48 | False |    ? | 115.0 ms |    NA |  0.97 |
|         |            |                    |              |       |      |          |       |       |
| Method3 | Job-AMPVQL |           .NET 5.0 |       net5.0 |  True |   44 | 126.0 ms |    NA |  1.00 |
| Method3 | Job-THQSYC |      .NET Core 3.1 | netcoreapp31 |  True |   44 | 124.0 ms |    NA |  0.98 |
| Method3 | Job-ZWOXKQ | .NET Framework 4.8 |        net48 |  True |   44 | 122.0 ms |    NA |  0.97 |
|         |            |                    |              |       |      |          |       |       |
| Method1 | Job-AMPVQL |           .NET 5.0 |       net5.0 |  True |    ? | 114.0 ms |    NA |  1.00 |
| Method1 | Job-THQSYC |      .NET Core 3.1 | netcoreapp31 |  True |    ? | 112.0 ms |    NA |  0.98 |
| Method1 | Job-ZWOXKQ | .NET Framework 4.8 |        net48 |  True |    ? | 110.0 ms |    NA |  0.96 |
|         |            |                    |              |       |      |          |       |       |
| Method2 | Job-AMPVQL |           .NET 5.0 |       net5.0 |  True |    ? | 120.0 ms |    NA |  1.00 |
| Method2 | Job-THQSYC |      .NET Core 3.1 | netcoreapp31 |  True |    ? | 118.0 ms |    NA |  0.98 |
| Method2 | Job-ZWOXKQ | .NET Framework 4.8 |        net48 |  True |    ? | 116.0 ms |    NA |  0.97 |

// Benchmarks3


|  Method |        Job |            Runtime |    Toolchain | IterationCount | LaunchCount | RunStrategy | UnrollFactor | WarmupCount |     Mean | Error | Ratio |
|-------- |----------- |------------------- |------------- |--------------- |------------ |------------ |------------- |------------ |---------:|------:|------:|
| Method1 | Job-AMPVQL |           .NET 5.0 |       net5.0 |        Default |     Default |     Default |           16 |     Default | 130.0 ms |    NA |  1.00 |
| Method1 | Job-THQSYC |      .NET Core 3.1 | netcoreapp31 |        Default |     Default |     Default |           16 |     Default | 129.0 ms |    NA |  0.99 |
| Method1 | Job-ZWOXKQ | .NET Framework 4.8 |        net48 |        Default |     Default |     Default |           16 |     Default | 128.0 ms |    NA |  0.98 |
| Method1 |        Dry |           .NET 5.0 |      Default |              1 |           1 |   ColdStart |            1 |           1 | 127.0 ms |    NA |  0.98 |
|         |            |                    |              |                |             |             |              |             |          |       |       |
| Method2 | Job-AMPVQL |           .NET 5.0 |       net5.0 |        Default |     Default |     Default |           16 |     Default | 134.0 ms |    NA |  1.00 |
| Method2 | Job-THQSYC |      .NET Core 3.1 | netcoreapp31 |        Default |     Default |     Default |           16 |     Default | 133.0 ms |    NA |  0.99 |
| Method2 | Job-ZWOXKQ | .NET Framework 4.8 |        net48 |        Default |     Default |     Default |           16 |     Default | 132.0 ms |    NA |  0.99 |
| Method2 |        Dry |           .NET 5.0 |      Default |              1 |           1 |   ColdStart |            1 |           1 | 131.0 ms |    NA |  0.98 |
```
